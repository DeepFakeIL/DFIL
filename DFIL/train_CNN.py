...
if __name__ == '__main__':
    ...
    parse.add_argument('--name', '-n', type=str, default='20230501_train_model_by_CDF2500')
    ...
    parse.add_argument('--val_list', '-vl' , type=str, default = 'train/2500_real_and_2500_fake_train.txt')
    
    parse.add_argument('--batch_size', '-bz', type=int, default=80)
    ...
    parse.add_argument('--model_path', '-mp', type=str, default='using_DFD(2500real_2500fake)_train_model_trained_by_FF++_and_DFDCP/9_demo.pkl')
